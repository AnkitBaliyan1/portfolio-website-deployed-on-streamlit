...
dashboard_images = os.path.join(base_dir, "portfolio/static/project-images/dashboard/")
...
sql_image_path = os.path.join(base_dir, "portfolio/static/project-images/sql/")
